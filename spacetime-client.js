var PlanningCardsSpacetimeBundle = (() => {
...
${originalIndentation}`;
  ...
  // client/module_bindings/index.ts
  var module_bindings_exports = {};
  __export(module_bindings_exports, {
...
${ty.variants.map(
  ...
  // client/module_bindings/hide_room_reducer.ts
  var hide_room_reducer_default = {
    roomId: t.string()
  };

  // client/module_bindings/join_room_reducer.ts
  ...
  // client/module_bindings/reset_room_reducer.ts
  var reset_room_reducer_default = {
    roomId: t.string()
  };

  // client/module_bindings/reveal_room_reducer.ts
  var reveal_room_reducer_default = {
    roomId: t.string()
  };

  // client/module_bindings/select_card_reducer.ts
  var select_card_reducer_default = {
    roomId: t.string(),
    participantId: t.string(),
  ...
  // client/module_bindings/set_name_reducer.ts
  var set_name_reducer_default = {
    roomId: t.string(),
    participantId: t.string(),
    name: t.string()
  };

  // client/module_bindings/set_ready_reducer.ts
  ...
  // client/module_bindings/participant_table.ts
  var participant_table_default = t.row({
    id: t.string().primaryKey(),
    roomId: t.string().name("room_id"),
    participantId: t.string().name("participant_id"),
    name: t.string(),
    ready: t.bool(),
    hasSelection: t.bool().name("has_selection"),
    connected: t.bool(),
    updatedAt: t.timestamp().name("updated_at")
  });

  // client/module_bindings/revealed_vote_table.ts
  var revealed_vote_table_default = t.row({
    id: t.string().primaryKey(),
    roomId: t.string().name("room_id"),
    participantId: t.string().name("participant_id"),
    selectedValue: t.string().name("selected_value"),
    phaseVersion: t.u64().name("phase_version"),
    updatedAt: t.timestamp().name("updated_at")
  });

  // client/module_bindings/room_table.ts
  var room_table_default = t.row({
    roomId: t.string().primaryKey().name("room_id"),
    phase: t.string(),
    phaseVersion: t.u64().name("phase_version"),
    resetVersion: t.u64().name("reset_version"),
    updatedAt: t.timestamp().name("updated_at")
  });
  ...
  var tablesSchema = schema({
    ...
    }, participant_table_default),
    revealedVote: table({
      name: "revealed_vote",
      indexes: [
        { accessor: "id", name: "revealed_vote_id_idx_btree", algorithm: "btree", columns: [
          "id"
        ] },
        { accessor: "roomId", name: "revealed_vote_room_id_idx_btree", algorithm: "btree", columns: [
          "roomId"
        ] }
      ],
      constraints: [
        { name: "revealed_vote_id_key", constraint: "unique", columns: ["id"] }
      ]
    }, revealed_vote_table_default),
    room: table({
      name: "room",
      indexes: [
  ...
  var reducersSchema = reducers(
    reducerSchema("hide_room", hide_room_reducer_default),
    reducerSchema("join_room", join_room_reducer_default),
    reducerSchema("reset_room", reset_room_reducer_default),
    reducerSchema("reveal_room", reveal_room_reducer_default),
    reducerSchema("select_card", select_card_reducer_default),
    reducerSchema("set_name", set_name_reducer_default),
  ...
  // client/spacetime-client.ts
  window.PlanningCardsSpacetime = module_bindings_exports;
})();
