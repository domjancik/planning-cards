...
import RevealedVoteRow from "./revealed_vote_table";
...
type __SchemaWithTableAccessorAliases = Omit<typeof tablesSchema.schemaType, "tables"> & {
  tables: typeof tablesSchema.schemaType.tables & {
    /** @deprecated Use `revealedVote` instead. This alias will be removed in the next major version. */
    readonly "revealed_vote": Omit<typeof tablesSchema.schemaType.tables["revealedVote"], "accessorName"> & { readonly accessorName: "revealed_vote" };
  };
};
...
export type DbView = __DbViewBase & {
  /** @deprecated Use `revealedVote` instead. This alias will be removed in the next major version. */
  readonly "revealed_vote": __DbViewBase["revealedVote"];
};

type __TablesBase = __QueryBuilder<typeof tablesSchema.schemaType>;
export type Tables = __TablesBase & {
  /** @deprecated Use `revealedVote` instead. This alias will be removed in the next major version. */
  readonly "revealed_vote": __TablesBase["revealedVote"];
};
